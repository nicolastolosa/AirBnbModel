...
The tasks executed on "train_eval" mode, will use the training data to train the
and configure the different parameters of the preprocessing steps and the model
itself. When executed on "predict" mode, the tasks will use learned parameters, 
extracted from the training steps, to preprocess the data and generate a new 
prediction.
